...
var (
	...
	cacheHomeNestUsercenterUserIdPrefix     = "cache:homeNestUsercenter:user:id:"
	cacheHomeNestUsercenterUserMobilePrefix = "cache:homeNestUsercenter:user:mobile:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, id int64) error {
	...
	homeNestUsercenterUserIdKey := fmt.Sprintf("%s%v", cacheHomeNestUsercenterUserIdPrefix, id)
...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	homeNestUsercenterUserIdKey := fmt.Sprintf("%s%v", cacheHomeNestUsercenterUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, homeNestUsercenterUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	homeNestUsercenterUserMobileKey := fmt.Sprintf("%s%v", cacheHomeNestUsercenterUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, homeNestUsercenterUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheHomeNestUsercenterUserIdPrefix, primary)
}
